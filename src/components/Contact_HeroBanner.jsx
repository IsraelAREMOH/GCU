...
const Contact_HeroBanner = () => {
  ...
  return (
    <div>
      <section
        className="w-full min-h-[650px] flex flex-col items-center justify-center px-4 py-16 sm:py-20 bg-[#0B102A] sm:bg-[url('/images/GCU18.webp')] 
bg-no-repeat bg-cover 
 bg-center"
      >
        <h1 className="text-3xl sm:text-5xl lg:text-6xl xl:text-7xl text-white text-center tracking-wide leading-tight">
          Creativity Is a
          <span className="block sm:inline bg-gradient-to-r from-[#02066F] to-blue-900 text-transparent bg-clip-text">
            Team Effort
          </span>
        </h1>
        <p className="mt-6 sm:mt-10 text-base sm:text-lg lg:text-xl text-center text-white max-w-2xl sm:max-w-3xl lg:max-w-4xl">
          Meet the talented creatives behind GCU Enterprise - a dynamic team of
          directors,who makes the magic happen.
        </p>
        <div className="flex justify-center mt-8 sm:mt-10">
          <a
            href="#"
            className="text-white bg-gradient-to-r from-[#02066f] to-blue-900 py-2 sm:py-3 px-6 sm:px-8 rounded-md text-sm sm:text-base"
            onClick={openModal}
          >
            Book A session
          </a>
